...
// eslint-disable-next-line
  ...
  return (
    <div className="grid grid-flow-col  p-5    sticky top-0 z-50 bg-white">
      <div className="flex col-span-1 w-40 h-8  ">
        <img
      ...
      <div className="col-span-10 text-center   ">
        <input
          className=" w-7/12 border border-gray-400 p-2 rounded-l-full "
          placeholder="Search"
          type="text"
          value={searchQuery}
